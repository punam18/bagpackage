...
<div class="row">
  ...
  $package_arr = array();
  array_push($package_arr,1);
  $get_package = $obj->select_prepare("* ","packages","status=?","s",$package_arr);
      ...
      if(is_array($get_package)){
        ...
        foreach ($get_package as $get_pack) {
          ...
          <tr>
            ...
            <td><?php echo $get_pack['place_name']; ?> </td>
            <td><?php echo $get_pack['price']; ?> </td>
            <td><?php echo $get_pack['days']; ?> </td>
            <td><?php echo $get_pack['travel_by']; ?> </td>
            <td>
              <?php echo '
              <a href="edit_package_form.php?id='.$get_pack['package_id'].'"><i class="fa fa-pencil-square-o" aria-hidden="true" onclick="return checkDelete()"></i></a>';
              echo'<a href="del_package.php?id='.$get_pack['package_id'].'"></i><i class="fa fa-trash-o" aria-hidden="true" onclick="return checkDelete()"></i></a>';
              ?>
            </td>
          </tr>
          <?php
